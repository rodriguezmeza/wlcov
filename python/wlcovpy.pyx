...
class CosmoComputationError(CosmoError):
    """
    Raised when wlcov could not compute at this point.
...
cdef class wlcov:
    ...
    _levellist = ["input","StartRun_Common","PrintParameterFile","SetNumberThreads", "MainLoop", "EndRun"]
...
#E
    ...
    # Now we can start with the actual code describing the wlcov
    ...
    def __cinit__(self, default=False):
        ...
        try:
          ...
          resource_path = abspath(importlib.resources.files('wlcovpy'))
    ...
    # taken at their default (in wlcov)
    ...
    def Run(self, level=["EndRun"]):
        ...
        This is called in Python, and this ensures that the wlcov instance
...
#B correction
        ...
        try:
            # --------------------------------------------------------------------
            # Check the presence for all wlcov modules in the list 'level'. If a
...
#E
        ...
        # At this point, the wlcov instance contains everything needed. The
