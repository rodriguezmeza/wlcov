...
.. list-table::
   ...
   * - ``addons/``
     - CLASS-style parser, getparam support, general utilities, and Cython PXD helpers.
   * - ``python/``
...
* separate build artifacts from source-tree tests so ``make all`` does not
  modify ``tests/notebooks_r2d2/IntegralCovMatrix``;
