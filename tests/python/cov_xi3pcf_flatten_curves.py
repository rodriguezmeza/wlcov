...
def main():
    ...
    ap.add_argument("--file-a", required=True, help="TXT A (p.ej. DES wlcf)")
    ap.add_argument("--file-b", default=None, help="TXT B (p.ej. DES wlcf)")
    ap.add_argument("--label-a", default="wlcf_a")
    ap.add_argument("--label-b", default="wlcf_b")
